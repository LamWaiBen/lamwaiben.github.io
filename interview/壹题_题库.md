...
```
### 第155题
思路: flex-grow, flex-shink, flex-basic

- flow-shink  
  - 按照flow-basis 和 flow-shink 乘积后的比例压缩空间
  - 计算公式: flow-basis - shinkWidth * (flow-basis * flow-shink) / totalBasis
  - left:  500 - 300 * (500 * 2 / 1400)
  - right:  400 - 300 * (400 * 1 / 1400)
- flow-grow  
  - 只需要按照flow-grow的比例分配剩余空间
